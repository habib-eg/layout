...
trait ResetsPasswords
{
     ...
     * @var string
     */
//    protected $viewName = 'auth.passwords.reset';
    /**
     * @var null
     */
...
//    protected $autoHash = false;
    ...
    public function showResetForm(Request $request)
    {
        ...
        return view($this->viewName)->with(
    ...
    protected function rules()
    {
        return [
            ...
            'password' => 'required'.(!\request()->wantsJson()?'|confirmed':'').'|min:8',
        ];
    }
     ...
     * @return bool
     */
    public function isAutoHash(): bool
    {
        return $this->autoHash ?? false;
    }
     ...
     * @return ResetsPasswords
     */
    public function setAutoHash(bool $autoHash)
    {
