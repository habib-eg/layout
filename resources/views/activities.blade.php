<x-layout-master>
    <x-slot name="header_title">
        <h1>@lang('layout.activities')</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">@lang('layout.dashboard')</a></div>
            <div class="breadcrumb-item">@lang('layout.activities')</div>
        </div>
    </x-slot>
            ...
            <div class="activities">
                @isset($activities)
                    @forelse ($activities as $activity)
                        <x-layout-activity color="primary" :activity="$activity">
                            <x-slot name="icon">
                                <i class="fa fa-user"></i> {{ $lastLoggedActivity->causer->name ?? __('layout.causer_name') }}
                            </x-slot>
                            <x-slot name="time">
